...
start_initial(ClusterSpec)->
    {ok,ActiveParents}=lib_control:start_parents(),
     
    [{ok,NodelogPod,NodelogApplSpec}]=lib_control:create_pods_based_appl("nodelog"),
    [{ok,_,_,_}]=lib_control:create_appl([{NodelogPod,"common",common}]),
    [{ok,_,_,_}]=lib_control:create_appl([{NodelogPod,"sd",sd}]),
    ok=lib_control:create_infra_appl({NodelogPod,"nodelog",nodelog},ClusterSpec),
  
    [{ok,DbPod,DbApplSpec}]=lib_control:create_pods_based_appl("db_etcd"),
    [{ok,_,_,_}]=lib_control:create_appl([{DbPod,"common",common}]),
    [{ok,_,_,_}]=lib_control:create_appl([{DbPod,"sd",sd}]),
    ok=lib_control:create_infra_appl({DbPod,"db_etcd",db_etcd},ClusterSpec),
    ...
    [{ok,InfraPod,InfraApplSpec}]=lib_control:create_pods_based_appl("infra_service"),
    [{ok,_,_,_}]=lib_control:create_appl([{InfraPod,"common",common}]),
    [{ok,_,_,_}]=lib_control:create_appl([{InfraPod,"sd",sd}]),
    ok=lib_control:create_infra_appl({InfraPod,"infra_service",infra_service},ClusterSpec),
